...
class Parser:
    ...
    def parse_accept_language2(self, header: str, s: List[str]) -> List[str]:
...
class TestClass(unittest.TestCase):
    ...
    def test_parse_accept_language(self):
        ...
        self.assertEqual(p.parse_accept_language('en-US,fr-CA,fr-FR', set(['fr-FR', 'en-US'])), ['en-US', 'fr-FR'])
        self.assertEqual(p.parse_accept_language('fr-CA,fr-FR', set(['en-US', 'fr-FR'])), ['fr-FR'])
    ...
    #     self.assertEqual(self.p.parse_accept_language2('fr-FR,*', ["en-US", "fr-CA", "fr-FR"]), ['fr-FR', 'en-US', 'fr-CA']) # is that possible that asterisk will be given at first or in the middle ?
